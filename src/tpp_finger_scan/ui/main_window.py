...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Rekapitulasi TPP PNS - Sekretariat DPRD Kota Bitung")
    ...
    def _build_ui(self) -> None:
        ...
        title = QLabel("Rekapitulasi TPP PNS")
        title.setObjectName("AppTitle")
        subtitle = QLabel("Sekretariat DPRD Kota Bitung · Sistem Rekap Disiplin Kehadiran & Potongan TPP")
        subtitle.setObjectName("Subtitle")
        title_box.addWidget(title)
        title_box.addWidget(subtitle)
        header.addLayout(title_box)
        header.addStretch()
        offline = QLabel("●  OFFLINE ENGINE")
        ...
        self.code_combo.addItems(("— Hapus kode —", "WFH", "TL", "I", "S"))
    ...
    def _import_pdf(self) -> None:
        ...
        try:
            ...
            session.employee_positions = self.repository.employee_positions(
                [employee.finger_id for employee in session.import_result.employees]
            )
